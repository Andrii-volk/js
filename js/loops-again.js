...
// for (let i = 1; i <= 10; i++) {
//   let row = ''; // Создаем пустую строку перед внутренним циклом
//   for (let j = 1; j <= 10; j++) {
//     let result = i * j;
//     row += result + ' '; // Просто добавляем число и пробел
//   }
//   console.log(row); // Выводим всю строку после внутреннего цикла
// }
//!-----------------------------------------------------------------------
//  4.Нарисовать пирамиду высоты n.
// Результат:
